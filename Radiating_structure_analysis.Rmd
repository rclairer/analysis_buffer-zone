...
fish_meta_structure <- filter(fish_meta_structure, Water_Col_Position == "R")
...
test <- summarySE(fishabundstruc, measurevar = "Abundance", groupvars = c("Transect_Number"))


ggplot(fish_meta, aes(x=as.factor(Transect_Number), y=Abundance)) +
