...
fish <- filter(fish, Subsite != "H-UNITS")
fish <- filter(fish, Subsite != "CONC")
fish <- filter(fish, Subsite != "DOMES")
fish <- filter(fish, Subsite != "TRAINCARS")
fish <- filter(fish, ID != "AR-372_NR1_2015-09-02_R_T1_T2_T3")
```
...
#write.csv(fish, file = "4_clean_data/fish_clean_data_output.csv", row.names = FALSE)
  write.csv(fish, file = "4_clean_data/fish_clean_data_output_structure2.csv", row.names = FALSE)
```
