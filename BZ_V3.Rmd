...
fish_data <- filter(fish_data_both_radiating, ID != "AR-345_TITAN_2015-10-15_R_T3")
...
# new ones
join4 <- cbind(join3[,1:7], join3[,79:102], join3[,8:78]) # species
...
#372 spring
plot.372.spring = ggplot(site372.spring, aes(x=as.numeric(NEAR_DIST_nautical), y=as.numeric(BCD))) 

plot.372.spring + geom_point () +theme_classic () +  scale_y_continuous(name="Bray Curtis Dissimilarity", limits=c(0, 1), breaks=seq(0, 1, by=0.05)) + scale_x_continuous(name = "Distance (nautical miles)", limits=c(0, 0.5), breaks=seq(0, 0.5,by=0.1)) + ggtitle("372 Winter") + geom_smooth(method = "loess")
