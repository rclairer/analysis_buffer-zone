...
species.data <- transform_data (data = species.data, transform_type = "box-cox")
...
geom_point (colour = "grey") + 
  ...
  geom_smooth(data = less40, colour = "black", fullrange = FALSE)+
  geom_smooth(data = greater70, colour = "black", fullrange = FALSE)+
  #testing+
  ggtitle("Bray Curtis Dissimilarty between Sites by Distance")
...
NRin <- filter(all.species.f, NEAR_Subsite == "NR1")
