...
######################################################################################################
#ABUNDANCE
out.abudance <- lm(abund ~ Transect_Number, data = comm_mets)
anova(out.abudance)
...
env_data$Structure_Type <- as.factor(env_data$Structure_Type)
...
permanova.everything <- adonis (species.data ~ Transect_Number * Sampling_Period * Site * Reef_Type * Structure_Type, env_data, permutations = 999, method = "bray")
permanova.everything
summary(permanova.everything)

permanova.everything2 <- adonis (species.data ~ Transect_Number + Sampling_Period + Site + Reef_Type + Structure_Type, env_data, permutations = 999, method = "bray")
